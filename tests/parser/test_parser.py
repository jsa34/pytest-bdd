...
from src.pytest_bdd.types import KeywordType
...
def test_parser():
    ...
    expected_document = GherkinDocument(
            ...
            children=[
                    ...
                    scenario=Scenario(
                        ...
                        steps=[
                            ...
                            Step(
                                id="3",
                                keyword="And",
                                keyword_type=KeywordType.CONJUNCTION,
                            ...
                            Step(
                                id="5",
                                keyword="Then",
                                keyword_type=KeywordType.OUTCOME,
                        ...
                        examples=[
                            DataTable(
                                ...
                                table_header=Row(
                                    ...
                                    cells=[
                                        Cell(location=Location(column=9, line=27), value="username"),
                                        Cell(location=Location(column=23, line=27), value="password"),
                                        Cell(location=Location(column=35, line=27), value="error_message"),
                                    ],
                                ),
                                table_body=[
                                    Row(
                                        ...
                                        cells=[
                                            Cell(location=Location(column=9, line=28), value="invalidUser"),
                                            Cell(location=Location(column=23, line=28), value="wrongPass"),
                                            Cell(
                                    ...
                                    Row(
                                        ...
                                        cells=[
                                            Cell(location=Location(column=9, line=29), value="user123"),
                                            Cell(location=Location(column=23, line=29), value="incorrect"),
                                            Cell(
                ...
                Child(
                    ...
                    scenario=Scenario(
                        ...
                        tags=[
                            ...
                            Tag(id="34", location=Location(column=10, line=49), name="@critical"),
                        ],
                        examples=[],
                    ),
                ),
                ...
                Child(
                    ...
                    rule=Rule(
                        ...
                        description="",
                        tags=[Tag(id="63", location=Location(column=3, line=87), name="@some-tag")],
                        children=[
                            Child(
                                background=None,
                                rule=None,
        ...
        comments=[
            ...
            Comment(location=Location(column=1, line=9), text="    # Background steps run before each scenario"),
            ...
            Comment(location=Location(column=1, line=54), text="  # Tags can be used to categorize scenarios"),
            Comment(location=Location(column=1, line=60), text="  # Using Data Tables for more complex data"),
            Comment(location=Location(column=1, line=76), text="  # Using Doc Strings for multi-line text"),
